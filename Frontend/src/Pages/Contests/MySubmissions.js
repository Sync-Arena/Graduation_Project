...
import Loading from "../Loading/Loading.js"; // Import the Loading component
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                ...
                const fetchedSubmissionsArray = await axios.get(`${process.env.REACT_APP_BASE_URL}/api/v1/judge/${contestId.id}/my-submissions`, config);
        ...
        fetchData();
    }, [auth.userData.token, contestId.id]);
