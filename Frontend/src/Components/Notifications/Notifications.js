...
const Notifications = () => {
  ...
  const handleAccept = async (notificationId) => {
    ...
    try {
      ...
      console.log(data);
      // Update notifications state to remove or update the accepted notification
  ...
  const handleReject = async (notificationId) => {
    ...
    try {
      ...
      console.log(data);
      // Update notifications state to remove or update the rejected notification
      setNotifications((prevNotifications) =>
        prevNotifications.filter((notif) => notif._id !== notificationId)
      );
    } catch (err) {
          ...
          <CSSTransition
            ...
            <div
              ...
              <div className="flex items-center">
                ...
                {(notification.type === "join_request" || (notification.type === "teamInvitaion" && notification.state === 'pending')) && (
