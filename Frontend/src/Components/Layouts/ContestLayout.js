...
function ContestLayout() {
    ...
    return (
        <div className=''>
            <nav className='flex justify-around border-b-2 border-main_border_color_dark mb-10 py-6 text-second_font_color_dark'>
                <NavLink to="" end className='inline-block basis-1/4 align-center mx-8 text-center p-2 rounded-md' style={({isActive}) => isActive ? activeStyles: null}>Problems</NavLink>
